...
@router.post("/", response_model=schemas.AdminBaseInfo, status_code=status.HTTP_201_CREATED)
...
@router.get("/", response_model=List[schemas.AdminBaseInfo])
...
@router.get("/{admin_id}", response_model=schemas.AdminBaseInfo)
